...
public class App {
    ...
    public static void main(String[] args) {
        ...
        userService.add(1, "rui", "ferrao@academiadecodigo.org", Security.getHash("academiadecodigo"),
                "Rui", "Ferrão", "912345678");
        userService.add(2, "faustino", "faustino@academiadecodigo.org", Security.getHash("academiadecodigo"),
                "João", "Faustino", "966666666");
        userService.add(3, "audrey", "audrey@academiadecodigo.org", Security.getHash("academiadecodigo"),
